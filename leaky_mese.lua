...
local definition_ghost = {    -- Beginn verschachtelte Tabelle
	...
	{name = "dirt_with_grass", description = "Dirt with Grass", tiles = {"default_grass.png", "default_dirt.png", {name = "default_dirt.png^default_grass_side.png",tileable_vertical = false}}, drawtype = ""},
	{name = "grass", description = "Grass", tiles = {"default_grass.png"}, drawtype = "nodebox"},
	{name = "gravel", description = "Gravel", tiles = {"default_gravel.png"}, drawtype = ""},
...
minetest.register_node("leaky:ghost_lava", {
	...
	inventory_image = minetest.inventorycube("default_lava.png^leaky_inv_ghost.png"),
	is_ground_content = false,
	paramtype = "light",
...
minetest.register_node("leaky:ghost_water", {
	...
	inventory_image = minetest.inventorycube("default_water.png^leaky_inv_ghost.png"),
	is_ground_content = false,
	paramtype = "light",
	groups = {cracky=3},
	sounds = mesecon.node_sound.stone,
